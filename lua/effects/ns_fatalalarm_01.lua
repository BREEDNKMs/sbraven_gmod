...
function EFFECT:Render() 
	...
	render.DrawSprite(Pos,spritescale,spritescale,Color(225,255,0)) 
	...
	render.DrawSprite(Pos,spritescale,spritescale,Color(225*(1-Cycle),255*(1-Cycle),0,255)) 
	render.DrawSprite(Pos,spritescale,spritescale,Color(225*(1-Cycle),255*(1-Cycle),0,255)) 
	render.DrawSprite(Pos,spritescale,spritescale,Color(225*(1-Cycle),255*(1-Cycle),0,255)) 
	render.DrawSprite(Pos,spritescale,spritescale,Color(225*(1-Cycle),255*(1-Cycle),0,255)) 
	-- render.SetMaterial(ma_a_alarm_02) 
	-- render.DrawSprite(Pos,128,128,Color(255,255,255,255)) 
	self:MA_A_Alarm_02_Render(Cycle,self:GetPos()) 
	self:MA_A_Alarm_02_Render(Cycle,self:GetPos()+Vector(0,0,(1-Cycle) * 15)) 
	self:MA_A_Alarm_02_Render(Cycle,self:GetPos()-Vector(0,0,(1-Cycle) * 15)) 
end 

function EFFECT:MA_A_Alarm_02_Render(Cycle,Pos)
